  ...
  (color-theme-install
   '(color-theme-brodie
     ((foreground-color . "light grey")
      ...
      (mouse-color . "black")
      (cursor-color . "dark slate grey")
      (border-color . "black")
      (background-mode . dark))
     (default ((t (nil))))
     (modeline ((t (:foreground "black" :background "dark grey"))))
     (modeline-buffer-id ((t (:foreground "black" :background "dark grey"))))
     (modeline-mousable ((t (:foreground "black" :background "dark grey"))))
     (modeline-mousable-minor-mode ((t (:foreground "black" :background "dark grey"))))
     (highlight ((t (:foreground "white" :background "darkslategray"))))
     (bold ((t (:bold t))))
     (italic ((t (:italic t))))
     ...
     (isearch ((t (:background "dark goldenrod"))))
     (isearch-lazy-highlight-face ((t (:background "#886600"))))
     ...
     (blank-tab-face ((t (:foreground "black" :background "light grey"))))
